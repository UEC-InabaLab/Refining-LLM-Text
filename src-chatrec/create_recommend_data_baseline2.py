...
def create_recommend_data(data, llm):
    ...
    for candidate_info in candidates_info_list:
        # ユーザーAの予測スコア生成
        predicted_score_A = predict_score_with_deberta_baseline2(dialogue_summary=dialogue_summary_A, rec_info=candidate_info)
        predicted_scores_A.append(predicted_score_A)
        
        # ユーザーBの予測スコア生成
        predicted_score_B = predict_score_with_deberta_baseline2(dialogue_summary=dialogue_summary_B, rec_info=candidate_info)
...
def main():
    ...
    output_dir = "../data_ChatRec/recommend_data_baseline2/"
