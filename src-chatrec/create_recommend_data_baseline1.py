...
def create_recommend_data(data, llm):
    ...
    for candidate_info in candidates_info_list:
        # ユーザーAの予測スコア生成
        recommend_sentence_A = llm.generate_rec_sentence_with_no_dialogue(candidate_info, temperature=0.2)
        ...
        # ユーザーBの予測スコア生成
        recommend_sentence_B = llm.generate_rec_sentence_with_no_dialogue(candidate_info, temperature=0.2)
...
def main():
    ...
    output_dir = "../data_ChatRec/recommend_data_baseline1/"
