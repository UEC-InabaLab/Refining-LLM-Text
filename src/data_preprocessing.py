...
FILE_PATH = "../data/annotation_data/annotations/"
OUTPUT_FILE_PATH = "../data/formatted_data/"
FILE_LIST = os.listdir(FILE_PATH)
SPOT_FILE_PATH = "../data/annotation_data/spot_info.json"
...
def create_formatted_data():
    output_dir = '../data/formatted_data'
