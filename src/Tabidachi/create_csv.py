...
# メイン処理
def main():
    directory_path = os.path.join(BASE_DIR, "../../data/Tabidachi/cloudworker-dataset-baseline1")  # 処理するディレクトリパス
    output_path = os.path.join(BASE_DIR, "../../data/Tabidachi/extracted_positive_candidates.csv")  # 出力CSVファイルのパス
