...
def create_recommend_data(data, rec_llm, summary_llm):
    ...
    for candidate_info in candidates_info_list:
        # ユーザーAの予測スコア生成
        recommend_sentence_A = rec_llm.generate_rec_sentence_with_no_dialogue(
        ...
        # ユーザーBの予測スコア生成
        recommend_sentence_B = rec_llm.generate_rec_sentence_with_no_dialogue(
            candidate_info, temperature=0.2
        )
...
def main():
    ...
    output_dir = os.path.join(BASE_DIR, "../../data/ChatRec/recommend_data_proposal_6/")
    ...
    for dir_name in os.listdir(input_dir):
        ...
        for filename in tqdm(os.listdir(test_dir)):
            ...
            with open(input_file_path, "r", encoding="utf-8") as file:
                data = json.load(file)
                output_data = create_recommend_data(
                    data, rec_llm=rec_llm, summary_llm=sum_llm
                )
...
def many_main():
    ...
    for i in range(5):
        ...
        output_dir = os.path.join(
            BASE_DIR, f"../../data/ChatRec/recommend_data_proposal_{i+1}/"
        )
